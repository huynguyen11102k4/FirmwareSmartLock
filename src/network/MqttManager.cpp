...
void MqttManager::begin(const AppConfig& cfg, const String& cid) {
  config = &cfg;
  clientId = cid;
...
void MqttManager::reconnect() {
  if (!initialized || mqtt.connected()) return;
...
bool MqttManager::publish(const String& topic,
...
void MqttManager::subscribe(const String& topic, int qos) {
